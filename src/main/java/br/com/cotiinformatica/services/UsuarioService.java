...
public class UsuarioService {
	...
	public String criarUsuario(CriarUsuarioRequestDto dto) {
		...
		//criando um obejto da classe usuário 
		var usuario = new Usuario();
		
		//capturando os dados do usuário atraves do DTO
	...
	/*
	 * MÉTODO PARA REALIZAR A AUTENTICAÇÃO DO USUARIO
	 * */
	...
	public String autenticarUsuario(AutenticarUsuarioRequestDto dto) {
		...
		if(usuario != null) {
			...
			//TODO gerar o TOKEN JWT do usuário
